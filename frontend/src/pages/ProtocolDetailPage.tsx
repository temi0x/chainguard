      ...
      <div className="container mx-auto px-4 py-24">
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-8">
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold">Protocol Analysis</h1>
            <p className="text-xl text-muted-foreground max-w-2xl">
              Connect your wallet to view detailed protocol risk assessments and
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {mockRiskBreakdowns[protocol.id] && (
            <RiskBreakdownPanel
              riskBreakdown={mockRiskBreakdowns[protocol.id]}
            />
          )}
        ...
        <AlertsList
          alerts={mockAlerts.filter(
            (alert) => alert.protocolId === protocol.id
          )}
        />
      </div>
    </div>
